...
const Categories: React.FC = () => {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-mela-pink-50 to-white -z-10"></div>
      
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute right-0 top-1/4 w-64 h-64 bg-mela-pink-100 rounded-full filter blur-3xl opacity-70 -z-10"></div>
        <div className="absolute left-0 bottom-1/4 w-80 h-80 bg-mela-pink-100 rounded-full filter blur-3xl opacity-50 -z-10"></div>
      </div>
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                  <motion.div 
                    ...
                    className="backdrop-blur-sm bg-white/10 rounded-lg p-4 border border-white/20 transition-transform duration-300 group-hover:translate-y-2"
                  >
